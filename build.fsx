...
Target "Lib_Build" (fun _ -> build "Be.Vlaanderen.Basisregisters.EntityFrameworkCore.EntityTypeConfiguration")

Target "Lib_Publish" (fun _ -> publish "Be.Vlaanderen.Basisregisters.EntityFrameworkCore.EntityTypeConfiguration")
Target "Lib_Pack" (fun _ -> pack "Be.Vlaanderen.Basisregisters.EntityFrameworkCore.EntityTypeConfiguration")
