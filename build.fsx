...
// Library ------------------------------------------------------------------------
Target.create "Lib_Build" (fun _ -> buildSource "Be.Vlaanderen.Basisregisters.EntityFrameworkCore.EntityTypeConfiguration")
Target.create "Lib_Publish" (fun _ -> publishSource "Be.Vlaanderen.Basisregisters.EntityFrameworkCore.EntityTypeConfiguration")
